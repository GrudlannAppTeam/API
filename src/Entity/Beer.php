...
class Beer
{
     ...
     *
     * @Groups({"beer:post", "beer:get", "beer:add-tasting-room", "tasting-room:join", "tasting-room:get:active", "review:statistic"})
     */
    private $id;
     ...
     *
     * @Groups({"beer:post", "beer:get", "tasting-room:join", "tasting-room:get:active", "review:statistic"})
     */
    private $name;
